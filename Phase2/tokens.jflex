...
//                the block comment.
commentbody		  = ([^\*]|(\*+[^\\]))
multiple_comments    = {blockcommentS}{commentbody}*?{blockcommentE}
comments	= {slash}{slash}.*(\n|\r|\r\n)
whitespace      = [ \n\t\r]
...
{floatlit}      	{return symbol(sym.Floatlit, new Float(yytext()));}
...
{multiple_comments}  	{/*ignore multi_comments*/}
